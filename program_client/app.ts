...
import {
    releasePokemonSendAndConfirm,
    CslSplTokenPDAs,
    derivePokeMetadataPDA,
    getPokeMetadata,
    initializeClient,
    catchPokemonSendAndConfirm,
    tradePokemonSendAndConfirm,
} from "./index";
...
async function main(feePayer: Keypair) {
     ...
     */
    const [gemPub] = derivePokeMetadataPDA(
        {
            mint: mint.publicKey,
        },
        progId,
    ...
    await catchPokemonSendAndConfirm({
        wallet: johnDoeWallet.publicKey,
        assocTokenAccount: johnDoeATA,
        element: "Fire",
        rarity: "Epic",
        shortDescription: "Its a Charlizard",
        signers: {
            feePayer: feePayer,
            funding: feePayer,
            mint: mint,
    ...
    await tradePokemonSendAndConfirm({
        wallet: janeDoeWallet.publicKey,
    ...
    await releasePokemonSendAndConfirm({
        mint: mint.publicKey,
        wallet: janeDoeWallet.publicKey,
        signers: {
            feePayer: feePayer,
